...
Route::delete('/delete_post/{id}', [ApiController::class,'delete_post']);
Route::get('/get_media_file/{id}', [ApiController::class,'get_media_file']);
Route::post('/post_media_file/{id}', [ApiController::class,'post_media_file']);
