<form action="<?php echo e(route('search.type', ['type' => $type])); ?>" class="search search-form w-100" method="post">
    <?php echo csrf_field(); ?>
    ...
    <?php if($type == 'creator'): ?>
        <button type="submit" class="search-btn"><?php echo e(get_phrase('Search')); ?></button>
    <?php endif; ?>

</form>
<?php /**PATH /home/hospitalpicks/public_html/bwclub.hospitalpicks.com/resources/views/frontend/paid_content/search.blade.php ENDPATH**/ ?>