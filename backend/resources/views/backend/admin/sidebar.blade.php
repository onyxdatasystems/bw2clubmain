<div class="sidebar">
    ...
    <ul class="nav-links">
        ...
        <li class="nav-links-li @if (Route::currentRouteName() == 'admin.view.category' ||
            ...
            <ul class="sub-menu">
                ...
                @else
                    <a class="@if (Route::currentRouteName() == 'admin.users.accountActiveReq') Active @endif"
                       href="{{ route('admin.users.accountActiveReq') }}">{{ get_phrase('Account Active Request') }}</a>
        </li>
        @endif
    </ul>
    </li>
    ...
    @if (addon_status('paid_content') == 1)
        @php
            $list = App\Models\ContentCreator\PaidContentPayout::where('status', false)->get();
        @endphp
    ...
    @if (addon_status('job') == 1)
        ...
        <li class="nav-links-li  @if (Route::currentRouteName() == 'admin.job' ||
            ...
            <ul class="sub-menu">
                ...
                <li><a class="@if (Route::currentRouteName() == 'admin.create.job.category') Active @endif"
                       href="{{ route('admin.create.job.category') }}">{{ get_phrase('Create Category') }}</a></li>
                <li><a class="@if (Route::currentRouteName() == 'admin.job.price.view') Active @endif"
                       href="{{ route('admin.job.price.view') }}">{{ get_phrase('Job Price') }}</a></li>
                <li><a class="@if (Route::currentRouteName() == 'admin.job.payment.history') Active @endif"
                       href="{{ route('admin.job.payment.history') }}">{{ get_phrase('Payment History') }}</a></li>
            </ul>
        </li>
    @endif
    {{-- Job Start Here --}}
