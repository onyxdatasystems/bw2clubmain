...
<main class="main new_fun_area">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-7 col-md-12 mb-12">
            ...
            <div class="col-xl-4 col-lg-5 col-md-12">
                <div class="fundraiser-progress-area border-none bg-white radius-8 mb-12">
                   
                    <div class="fund-progress-title d-flex justify-content-between">
                        <h3 class="text_22">{{get_phrase('Fundraiser Progress')}}</h3>
                        <a href="{{ route('fundraiser.index') }}" class="btn back_btns btn-primary"><i class="fa-solid fa-left-long me-2"></i>{{get_phrase('Back')}}</a>
                    </div>
                ...
                @if ($friendships->count() > 0)
                    <div class="friend-invite-area border-none bg-white radius-8 mb-12 pb-0">
                ...
                <div class="created-owner-area border-none bg-white radius-8 mb-12">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        @if ($user_data->id != auth()->user()->id)
                            <a href="{{ route('chat', $user_data->id) }}" class="btn_2 contacted">{{get_phrase('Contact')}}</a>
                        @else
                        @endif
                    </div>
                </div>
