...
--
-- Host: localhost:3306
-- Generation Time: Mar 09, 2025 at 03:53 AM
...
--
-- Database: `hospitalpicks_bw2club`
--
...
INSERT INTO `addons` (`id`, `title`, `parent_id`, `features`, `version`, `unique_identifier`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Fundraiser', NULL, 'test', 1.2, 'fundraiser', 1, NULL, NULL),
(2, 'job', NULL, 'test', 1.1, 'job', 1, NULL, NULL),
(3, 'Paid Content', NULL, 'Explore creators \n-Become creator \n-Create paid posts \n-Create package \n-Get paid \n-Payout option \n-Payment list \n-Manage request \n-Creator payment \n', 1.2, 'paid_content', 1, NULL, NULL);
...
CREATE TABLE `fundraisers` (
  ...
  `raised_amount` int DEFAULT NULL,
  `status` int DEFAULT NULL,
  `share` int DEFAULT NULL,
  `invited` longtext COLLATE utf8mb4_unicode_ci,
  `user_id` int DEFAULT NULL,
...
(1, 'Popular', '', '2025-03-09 09:42:32'),
(2, 'Animals', '', '2025-03-09 09:42:32'),
(3, 'Arts and Culture', '', '2025-03-09 09:42:32'),
(4, 'Business', '', '2025-03-09 09:42:32'),
(5, 'Community & social action', '', '2025-03-09 09:42:32'),
(6, 'Crisis relief', '', '2025-03-09 09:42:32'),
(7, 'Education', '', '2025-03-09 09:42:32');
...
CREATE TABLE `fundraiser_donations` (
  ...
  `payment_getway` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `jobs` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `starting_salary_range` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ending_salary_range` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `start_date` timestamp NULL DEFAULT '2025-03-09 09:42:52',
  `end_date` timestamp NULL DEFAULT '2025-03-09 09:42:52',
...
(1446, 'english', 'Text-to-Image Generator', 'Text-to-Image Generator', '2025-03-09 03:36:55', '2025-03-09 03:36:55'),
(1447, 'english', 'Enter your text:', 'Enter your text:', '2025-03-09 03:36:55', '2025-03-09 03:36:55'),
(1448, 'english', 'Generate Image', 'Generate Image', '2025-03-09 03:36:55', '2025-03-09 03:36:55'),
(1449, 'english', 'Download Image', 'Download Image', '2025-03-09 03:36:56', '2025-03-09 03:36:56'),
(1450, 'english', 'Account Active Request', 'Account Active Request', '2025-03-09 03:37:06', '2025-03-09 03:37:06'),
(1451, 'english', 'Fundraiser', 'Fundraiser', '2025-03-09 03:42:33', '2025-03-09 03:42:33'),
(1452, 'english', 'Success payout', 'Success payout', '2025-03-09 03:42:33', '2025-03-09 03:42:33'),
(1453, 'english', 'Pending payout', 'Pending payout', '2025-03-09 03:42:33', '2025-03-09 03:42:33'),
(1454, 'english', 'Paid Content', 'Paid Content', '2025-03-09 03:43:11', '2025-03-09 03:43:11'),
(1455, 'english', 'Authors', 'Authors', '2025-03-09 03:43:11', '2025-03-09 03:43:11'),
(1456, 'english', 'Payout report', 'Payout report', '2025-03-09 03:43:11', '2025-03-09 03:43:11'),
(1457, 'english', 'Pending report', 'Pending report', '2025-03-09 03:43:11', '2025-03-09 03:43:11'),
(1458, 'english', 'Become a paid content creator and earn money', 'Become a paid content creator and earn money', '2025-03-09 03:43:36', '2025-03-09 03:43:36'),
(1459, 'english', 'Get\r\n    Started', 'Get\r\n    Started', '2025-03-09 03:43:36', '2025-03-09 03:43:36'),
(1460, 'english', 'Tell us about your page', 'Tell us about your page', '2025-03-09 03:43:36', '2025-03-09 03:43:36'),
(1461, 'english', 'Search', 'Search', '2025-03-09 03:43:36', '2025-03-09 03:43:36'),
(1462, 'english', 'No creator is available', 'No creator is available', '2025-03-09 03:43:36', '2025-03-09 03:43:36'),
(1463, 'english', 'Google Analytics Id', 'Google Analytics Id', '2025-03-09 03:44:02', '2025-03-09 03:44:02'),
(1464, 'english', 'Hugging Face Auth Key', 'Hugging Face Auth Key', '2025-03-09 03:44:02', '2025-03-09 03:44:02'),
(1465, 'english', 'Get Hugging Face Auth Key', 'Get Hugging Face Auth Key', '2025-03-09 03:44:02', '2025-03-09 03:44:02'),
(1466, 'english', 'Issue Date', 'Issue Date', '2025-03-09 03:48:17', '2025-03-09 03:48:17'),
(1467, 'english', 'Payout Date', 'Payout Date', '2025-03-09 03:48:17', '2025-03-09 03:48:17'),
(1468, 'english', 'Method', 'Method', '2025-03-09 03:48:17', '2025-03-09 03:48:17');
...
CREATE TABLE `paid_content_creators` (
  ...
  `social_accounts` longtext COLLATE utf8mb4_unicode_ci,
  `status` int DEFAULT NULL,
  `config_setting` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `paid_content_subscriptions` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0',
  `admin_commission` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(10, 'system_name', 'BW2Club', '2022-09-20 03:52:50', '2025-03-09 09:47:42'),
(11, 'system_title', 'The Female Power Entrepreneur network', '2022-09-20 03:53:27', '2025-03-09 09:47:42'),
(12, 'system_email', 'admin@example.com', '2022-09-20 03:53:27', '2025-03-09 09:47:42'),
(13, 'system_phone', '324234234', '2022-09-20 03:53:57', '2025-03-09 09:47:42'),
(14, 'system_fax', '324234234', '2022-09-20 03:53:57', '2025-03-09 09:47:42'),
(15, 'system_address', 'New York, USA', '2022-09-20 03:54:41', '2025-03-09 09:47:42'),
(16, 'system_footer', 'BW2CLUB', '2022-09-20 03:54:41', '2025-03-09 09:47:42'),
(17, 'system_footer_link', 'https://bw2club.com', '2022-09-20 03:55:08', '2025-03-09 09:47:42'),
(18, 'system_dark_logo', '432.png', '2022-09-20 03:55:08', '2025-03-09 09:47:17'),
(19, 'system_light_logo', '387.png', '2022-09-20 03:55:27', '2025-03-09 09:47:17'),
(20, 'system_fav_icon', '803.png', '2022-09-20 03:55:27', '2025-03-09 09:47:17'),
(21, 'version', '2.6', '2022-09-20 03:55:27', '2022-09-19 20:39:06'),
(22, 'language', 'english', '2022-09-20 03:55:27', '2022-09-19 20:39:06'),
(23, 'public_signup', '1', '2022-09-20 03:55:27', '2025-03-09 09:47:42'),
...
(25, 'ad_charge_per_day', '0.1', '2022-09-20 03:55:27', '2025-03-09 09:47:42'),
(26, 'system_currency', 'USD', '2022-09-07 06:07:09', '2025-03-09 09:47:42'),
(27, 'system_language', 'english', '2022-09-07 06:07:09', '2025-03-09 09:47:42'),
(28, 'purchase_code', 'sdsds', '2022-09-07 06:07:09', '2023-03-30 09:52:44'),
(29, 'google_analytics_id', NULL, '2022-09-07 06:07:09', '2025-03-09 09:47:42'),
(30, 'meta_pixel_id', NULL, '2022-09-07 06:07:09', '2025-03-09 09:47:42'),
(31, 'commission_rate', '1', '2023-08-18 18:21:32', '2025-03-09 09:47:42'),
...
(37, 'hugging_face_auth_key', 'Auth Key', '2024-02-19 09:25:43', '2025-03-09 09:47:42');
...
(1, 'admin', NULL, 'gooption@yahoo.com', '$2y$10$buji.3NqaHA8L4.Y73ryy.SszwW1YEaWJ3fDgsvZNWz7bEO.GfM5.', 'Admin Ksenija', NULL, '[]', NULL, 'male', NULL, 'sd', NULL, NULL, NULL, '234', '1741491358', NULL, NULL, NULL, NULL, NULL, '2025-03-09 09:48:16', 'Europe/Berlin', '2025-03-09 09:35:58', NULL, NULL, '2025-03-09 09:48:16', NULL, NULL);
...
--
-- Indexes for table `job_applys`
--
ALTER TABLE `job_applys`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `job_wishlists`
--
ALTER TABLE `job_wishlists`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `job_applys`
--
ALTER TABLE `job_applys`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `job_wishlists`
--
ALTER TABLE `job_wishlists`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
