    ...
    <div class="product-form new_job_f mb-3 bg-white p-3 pb-12 radius-8">
        <div class="nm_place njob d-flex pagetab-head border-none  align-items-center justify-content-between" >
            ...
            <div class="btn-inline ">
                <a href="{{route('create.job')}}" class="btn btn-sm @if(Route::currentRouteName() == 'create.job') primary @else dash @endif "> <i class="fa fa-circle-plus me-2"></i>{{ get_phrase('Create Job') }}</a>
            </div>
        </div>
