                            ...
                            <ul class="items-local">
                                ...
                                <ul class="d-flex job-btn">
                                    @if($job->status == '1' && $job->start_date <= now() && $job->end_date >= now())
                                        <li><a href="#" class="btn btn-primary">{{ get_phrase('Active') }}</a></li>
                                    @elseif($job->status == '1' && now() < $job->start_date  )
                                        <li><a href="#" class="btn btn-info">{{ get_phrase('Holding') }}</a></li>
                                    @elseif($job->status == '1' && $job->end_date  <  now())
                                        <li><a href="#" class="btn btn-warning">{{ get_phrase('Expire') }}</a></li>
                                    @else
                                        <li><a href="#" class="btn btn-pending">{{ get_phrase('Pending') }}</a></li>
                                    @endif
